            ...
            <div className="order-detail-container">
                ...
                <div>
                    <form className="register-form" onSubmit={handleSaveUser}>
                        {
                            orderSingle.status == 0 ? '' : orderSingle.ispaid == 1 ? <div className="order-cancel green small"><span>ĐÃ THANH TOÁN</span></div>
                            : <div className="order-cancel small"><span>CHƯA THANH TOÁN</span></div>
                        }
