...
const step1Content = <h1>Chưa xác nhận</h1>;
const step2Content = <h1>Đã xác nhận</h1>;
const step3Content = <h1>Đang giao</h1>;
const step4Content = <h1>Cancel</h1>;
...
function OrderDetail() {
    ...
    // useEffect(() => {
    //     if (orderSingle) {
    //        setStartStep(orderSingle.status)
    //     }
    // }, []);
                        ...
                        <div className="">
                            {
                                ...
                                <div className="order-cancel"><span>ORDER CANCEL</span></div>
                                : startStep ?
                                <StepProgressBar
                                    wrapperClass='normal-process'
                                    buttonWrapperClass='btn-process-step-bar'
                        ...
                        <div className="row-hh">
                            ...
                            <div className="col-6">
                                <div className="form-group">
                                    ...
                                    <input id="email" type="text" className="form-control" placeholder=" " readonly
                                        value={orderSingle.customer.name}
                                    //onChange={handleChangeFormData('email')}
                                    />
                                    {/* {formValidError.email && <label className="label-error">{formValidError.email}</label>} */}
                                </div>
                        ...
                        <div className="row-hh">
                            <div className="col-6">
                                <div className="form-group">
                                    ...
                                    <input id="email" type="text" className="form-control" placeholder=" " readonly
                                        value={orderSingle.employee ? orderSingle.employee.id : ''}
                                    //onChange={handleChangeFormData('email')}
                                    />
                                    {/* {formValidError.email && <label className="label-error">{formValidError.email}</label>} */}
                                </div>
                            ...
                            <div className="col-6">
                                <div className="form-group">
                                    ...
                                    <input id="email" type="text" className="form-control" placeholder=" " readonly
                                        value={orderSingle.employee ? orderSingle.employee.name : ''}
                                    //onChange={handleChangeFormData('email')}
                                    />
                                    {/* {formValidError.email && <label className="label-error">{formValidError.email}</label>} */}
                                </div>
